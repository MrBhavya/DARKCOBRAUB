...
async def hmm(yes):
    ...
    pm_caption += "➾ **License**  ☞ [Dragon’s Asuna](https://github.com/MrBhavya/DARKCOBRAUB/blob/master/LICENSE)\n"
    pm_caption += "➾ **Copyright By** ☞ [𝙳𝙰𝚁𝙺-𝙲𝙾𝙱𝚁𝙰](https://github.com/DARK-COBRA/DARKCOBRA)\n\n"
